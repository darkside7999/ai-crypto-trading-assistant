...
set_env_line "$BACKEND/.env" "AI_MODEL" "qwen/qwen3-235b-a22b:free"
set_env_line "$BACKEND/.env" "AI_FALLBACK_MODEL" "google/gemini-2.5-flash-lite"
set_env_line "$BACKEND/.env" "OLLAMA_BASE_URL" "http://127.0.0.1:11434"
set_env_line "$BACKEND/.env" "OLLAMA_MODEL" "qwen3:8b"

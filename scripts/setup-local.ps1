...
Set-EnvLine -Path $backendEnv -Key "AI_MODEL" -Value "qwen/qwen3-235b-a22b:free"
Set-EnvLine -Path $backendEnv -Key "AI_FALLBACK_MODEL" -Value "google/gemini-2.5-flash-lite"
Set-EnvLine -Path $backendEnv -Key "OLLAMA_BASE_URL" -Value "http://127.0.0.1:11434"
Set-EnvLine -Path $backendEnv -Key "OLLAMA_MODEL" -Value "qwen3:8b"
...
Set-EnvLine -Path $backendEnv -Key "BINANCE_TESTNET_KEY_TYPE" -Value "hmac"
